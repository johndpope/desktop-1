...
//		NRS.useNQT =(NRS.isTestNet && NRS.lastBlockHeight >= 76500) || (!NRS.isTestNet && NRS.lastBlockHeight >= 132000);
        NRS.useNQT =(NRS.isTestNet && NRS.lastBlockHeight >= 0) || (!NRS.isTestNet && NRS.lastBlockHeight >= 0);
		//if (!NRS.isTestNet && NRS.lastBlockHeight >= 13500) {
        if (!NRS.isTestNet && NRS.lastBlockHeight >= 0) {
