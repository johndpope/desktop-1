...
final class PeerImpl implements Peer {
    ...
    public long getDownloadedVolume() {
        ...
        Logger.logMessage("下载量为"+downloadedVolume);
        return downloadedVolume;
    }

    void updateDownloadedVolume(long volume) {
        Logger.logMessage("开始更新下载量......."+volume);
        synchronized (this) {
    ...
    public long getUploadedVolume() {
        ...
        Logger.logMessage("获取上载量"+uploadedVolume);
    ...
    Logger.logMessage("开始发送一个请求给"+announcedAddress+"或者"+peerAddress);
        JSONObject response;
        ...
        try {
            ...
            Logger.logMessage("发送的目标地址：addreess   "+address);
            ...
            Logger.logMessage("279---开始更新上载量");
            updateUploadedVolume(cos.getCount());

            if (connection.getResponseCode() == HttpURLConnection.HTTP_OK) {
                Logger.logMessage("返回OK");
            ...
            if (! (e instanceof UnknownHostException || e instanceof SocketTimeoutException || e instanceof SocketException)) {
                Logger.logMessage("Error sending JSON request", e);
            }
