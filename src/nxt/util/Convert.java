...
public final class Convert {
    ...
    public static int getEpochTime() {
        Logger.logDebugMessage("Convert getEpochTime 当前的时间为="+System.currentTimeMillis());
        Logger.logDebugMessage("Convert getEpochTime 创始块的时间戳="+Constants.EPOCH_BEGINNING);
