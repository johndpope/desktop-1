...
public class DesktopSystemTray {
    ...
    private void displayStatus() {
       ...
       // addDataRow(statusPanel, "Database URL", Db.db == null ? "unavailable" : Db.db.getUrl());
        addDataRow(statusPanel, "Database URL", "nxt.dbUrl=jdbc:h2:./nxt_db/nxt;DB_CLOSE_ON_EXIT=FALSE");
       ...
       addEmptyRow(statusPanel);
        ...
        if (lastBlock != null) {
            ...
            addDataRow(statusPanel, "Time", "2017"/*String.valueOf(new Date(Convert.fromEpochTime(lastBlock.getTimestamp())))*/);
            addDataRow(statusPanel, "Seconds passed", String.valueOf(Convert.getEpochTime() - lastBlock.getTimestamp()));
        ...
        addDataRow(statusPanel, "Process id", "");
        addEmptyRow(statusPanel);
