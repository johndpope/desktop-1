...
final class BlockImpl implements Block {
    ...
    void sign(String secretPhrase) {
        ...
        blockSignature = Crypto.sign(data2, secretPhrase);/*块的签名为*/
        StringBuilder builder=new StringBuilder();
        int i=0;
        for ( i=0;i<blockSignature.length;i++){
       builder.append(blockSignature[i]+",");
         }
        Logger.logMessage("block的签名是 blockSignature=:"+builder.toString()+"块的签名的长度是:"+i);
    ...
    boolean verifyGenerationSignature() throws BlockchainProcessor.BlockOutOfOrderException {
        ...
        try {
            ...
            Logger.logMessage("BlockImpl中的生成器的签名的长度是="+generationSignature.length);
            //---------------因为程序中将1
    ...
    void apply() {
        ...
        /*将totalFeeNQT添加到UnconfirmedBalanceNQT中*/
        generatorAccount.addToBalanceAndUnconfirmedBalanceNQT(totalFeeNQT);
        /*将totalFeeNQT 添加到addToForgedBalanceNQT中*/
    ...
    void undo() {
        ...
        /*撤销账户，因为原则上会将一个块的的生成者存入account中*/
    ...
    /**
     * 根据上一个区块中重新计算Basetarget
     * @param previousBlock
     */
    private void calculateBaseTarget(BlockImpl previousBlock) {
    Logger.logMessage("Blockimpl calculateBaseTarget 计算target的值........");
